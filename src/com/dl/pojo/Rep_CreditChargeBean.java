...
public class Rep_CreditChargeBean {
	...
	public String getAccntof() {
		return accntof;
	}
	public void setAccntof(String accntof) {
		this.accntof = accntof;
	}
	...
	public String toString() {
		return "Rep_CreditChargeBean [accnt=" + accnt + ", accntof=" + accntof
				+ ", balance=" + balance + ", billno=" + billno + ", charge="
				+ charge + ", code=" + code + ", credit=" + credit + ", gname="
				+ gname + ", gt_id=" + gt_id + ", hotelid=" + hotelid
				+ ", hotelname=" + hotelname + ", last_date=" + last_date
				+ ", last_id=" + last_id + ", last_ip=" + last_ip
				+ ", last_shift=" + last_shift + ", log_date=" + log_date
				+ ", log_id=" + log_id + ", log_ip=" + log_ip + ", log_shift="
				+ log_shift + ", number=" + number + ", ref1=" + ref1
				+ ", ref2=" + ref2 + ", ref3=" + ref3 + ", roomno=" + roomno
				+ ", sign=" + sign + ", sno=" + sno + ", sta=" + sta
				+ ", subcode=" + subcode + ", sysdate=" + sysdate + ", tofrom="
				+ tofrom + "]";
	}
